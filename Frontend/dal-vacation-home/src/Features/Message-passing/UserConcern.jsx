...
const UserConcern = () => {
  ...
  useEffect(() => {
    axios.post('https://2on9ao75l3.execute-api.us-east-1.amazonaws.com/test/fetchingconcerns', {
  ...
  const handleClose = (enquiryid) => {
    ...
    if (concernToUpdate) {
      axios.put('https://umwbe2qvi2.execute-api.us-east-1.amazonaws.com/test/closeticket', {
